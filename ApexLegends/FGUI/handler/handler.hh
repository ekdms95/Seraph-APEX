...
namespace fgui {
	...
	struct style {
		...
		*/
		...
		std::array<fgui::color, 3> container = { fgui::color(85, 85, 85), fgui::color(25, 25, 25), fgui::color(140, 27, 166) };
		std::array<fgui::color, 4> keybinder = { fgui::color(85, 85, 85), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(61, 158, 255) };
		std::array<fgui::color, 6> label = { fgui::color(85, 85, 85), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(140, 27, 166), fgui::color(140, 27, 166), fgui::color(140, 27, 166) };
		...
		std::array<fgui::color, 5> window = { fgui::color(25, 25, 25), fgui::color(40, 40, 40), fgui::color(15, 7, 41), fgui::color(140, 27, 166), fgui::color(140, 27, 166) };
	};
